...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int useHeight = height - getPaddingTop() - getPaddingBottom();
        //开始遍历所有的子控件
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (curRow.width + childWidth > useWidth) {//新加一行
        ...
        setMeasuredDimension(flowWidth + getPaddingRight(), preElementBottom + getPaddingBottom());
    }
    ...
    public class Element {
        ...
        public Element(View view, int top, int left, int right, int bottom) {
            this.view = view;
            this.top = top;
            this.left = left;
            this.right = right;
